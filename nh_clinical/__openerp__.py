# -*- encoding: utf-8 -*-
{
    ...
    'demo': ['data/dev_users.xml',
             ...
             'data/ward_a/demo_discharges.xml',
             'data/ward_b/demo_discharges.xml',
             'data/ward_c/demo_discharges.xml',
             'data/ward_d/demo_discharges.xml',
             'data/ward_e/demo_discharges.xml',
             ],
    'css': [],
    'js': [],
    'qweb': [],
