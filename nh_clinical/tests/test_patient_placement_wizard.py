...
class TestPatientPlacementWizard(TransactionCase):
    ...
    def test_get_placement_ids_is_called_with_domain(self):
        ...
        self.placement_pool.search.assert_called_with(cr, uid, domain, context=None)
        del self.placement_pool.search

    def test_get_recent_placement_returns_a_list(self):
        cr, uid = self.cr, self.uid
